...
-  Avoid doing any serious work in excel.
...
- If you have a GitHub account, sit back and relax for a minute.
...
- There are hundreds of git commands, but 95% of the time you will only need three commands: `commit`, `push`, `pull` (maybe also `add`  and adjust the `remote` repositories you sync with).
...
- Install/update RStudio and R
- Make sure you can access the github classroom (Blackboard)
- Try to commit a change to assignment 0 so that I know you can
