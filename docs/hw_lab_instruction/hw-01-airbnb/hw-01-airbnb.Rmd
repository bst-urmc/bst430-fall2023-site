...
author: "Matt McCall, based on the course by Andrew McDavid"
...
```{r load-packages, message = FALSE}
nycbnb = read_csv("https://bst-urmc.github.io/bst430-fall2023-site/hw_lab_instruction/hw-01-airbnb/data/nylistings.csv")
```
