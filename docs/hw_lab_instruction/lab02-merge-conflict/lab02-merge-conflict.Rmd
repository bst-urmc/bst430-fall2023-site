...
-   Assign the numbers 1, 2, 3, 4, and 5 to each of the team members. If your team has fewer than 5 people, some people will need to have multiple numbers. If your team has more than 5 people, some people will need to share some numbers.

## Let's cause a merge conflict!

Our goal is to see two different types of merges: first we'll see a type of merge that git can't figure out how to do on its own (a **merge conflict**) and requires human intervention, then another type where git can figure out how to merge without human intervention.
...
**Role 5 (pick anyone except the Role 4 participant)**
...
4 points if questions 1 and 2 have answers added as text.
5 points for >= five commits with informative messages made to the repo.
6 points for commits being from alternating team members following the directions above to create and resolve merge conflicts.
