...
<!--     <!-- * Lab 1 [instructions](hw_lab_instruction/lab01-hello-r/lab01-hello-r.html) and repo (accept GH classroom [invite](https://classroom.github.com/a/Zqu2rV6v)). Due 5pm, Sept 16. --> -->
...
<!--     <!-- * HW 1 assigned.  [instructions](hw_lab_instruction/hw-01-airbnb/hw-01-airbnb.html) and repo (accept GH classroom [invite](https://classroom.github.com/a/MQ3t9onK)). --> -->
...
<!--     <!-- *  [Lab 3](hw_lab_instruction/lab03-laquinta-uno/lab03-laquinta-uno.html).  To be completed in same group as lab 2, [invitation here](https://classroom.github.com/a/mvAGD44S). --> -->
...
<!--     <!-- * HW 2 assigned.  [instructions](hw_lab_instruction/hw02-accidents/hw02-accidents.html) and repo (accept GH classroom [invite](https://classroom.github.com/a/fy4E-H-b)). --> -->
...
<!--     <!-- [Invitation here](https://classroom.github.com/a/566Cy7tL).  --> -->
...
<!-- <!-- * Finish lab 4. --> -->
<!-- 11. [Text processing](lecture/l10-text.html) -->
<!--     <!-- * HW 3 assigned.  [instructions](hw_lab_instruction/hw03-fatal-geography/hw03-fatal-geography.html) and repo (accept GH classroom [invite](https://classroom.github.com/a/6sqI7bjg)). --> -->
<!--     <!-- * HW 3 [solutions](hw_lab_instruction/hw03-fatal-geography/hw03.html) --> -->
<!-- 12. [Text analysis](lecture/l10-text-ii.html) -->
<!--     <!-- *  [Lab 5](hw_lab_instruction/lab05-sadplots/lab05-sadplots.html).  Pair up; take turns and then you won't have so many GitHub problems. [Invitation here](https://classroom.github.com/a/sFi-IjD6).  --> -->
